...
dir = r"C:\Users\hp\Desktop\标准事件推送备份\125-1212\事件推送"
filename_excel = []
frames = []
...
dir = r"C:\Users\hp\Desktop\标准事件推送备份\125-1212\正式单"
filename_excel = []
frames = []
for root, dirs, files in os.walk(dir):
    for file in files:
...
AND order_time between '2021-12-05 16:00:00' and '2021-12-12 16:00:00'
AND is_deleted='n'
GROUP BY 1,2,3
"""
...
r1.to_excel(r'C:\Users\hp\Desktop\标准事件推送\125-1212\标准事件推送率.xlsx',index=False)
