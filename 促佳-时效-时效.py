...
for index,row in d9.iterrows():
    ...
    sd = datetime.date.today() + datetime.timedelta(-19)
    print(ed)
    print(sd)
    s10 = """
                with 
            ...
            where t1.per>=0.90
            GROUP BY 1,2
            """.format(sd,ed, channel_code, des, sd,ed, channel_code, des)
    fwk = execude_sql(s10)
    dis = {}
    dis["channel_code"] = channel_code
    dis["des"] =des
    try:
        dis["90f"] = float(fwk.iloc[0,2])
    except:
        dis["90f"] = 0
    list4.append(dis)
print(list4)
...
for i in list4:
    d7.loc[(d7.channel_code == i["channel_code"]) & (d7.des == i["des"]),'参考时效'] = i["90f"]
print(d7)
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "ES") , '期望值'] = "10"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "FR") , '期望值'] = "10"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "CZ") , '期望值'] = "12"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "GB") , '期望值'] = "7"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "IT") , '期望值'] = "8"
d7.loc[(d7.channel_code == "CNE华东欧电") & (d7.des == "RO") , '期望值'] = "0"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "PL") , '期望值'] = "14"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "GR") , '期望值'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "SK") , '期望值'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "SE") , '期望值'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "HU") , '期望值'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "RO") , '期望值'] = "22"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "LT") , '期望值'] = "20"


d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "ES") , 'KPI'] = "10"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "FR") , 'KPI'] = "10"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "CZ") , 'KPI'] = "12"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "GB") , 'KPI'] = "7"
d7.loc[(d7.channel_code == "CNE全球优先") & (d7.des == "IT") , 'KPI'] = "8"
d7.loc[(d7.channel_code == "CNE华东欧电") & (d7.des == "RO") , 'KPI'] = "0"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "PL") , 'KPI'] = "14"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "GR") , 'KPI'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "SK") , 'KPI'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "SE") , 'KPI'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "HU") , 'KPI'] = "16"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "RO") , 'KPI'] = "22"
d7.loc[(d7.channel_code == "CNE全球特惠") & (d7.des == "LT") , 'KPI'] = "20"
d7["项目名称"] = "促佳"
d7.to_excel("F:/周报/促佳/时效.xlsx")
